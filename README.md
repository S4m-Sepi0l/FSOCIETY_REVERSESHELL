...
1. start the script > [python fs0ciety.py]
2. Listen at port 4444
3. execute the payload on the victim machine
4. You should get something like this:
5. <img width="448" height="90" alt="Captura de pantalla 2026-05-06 100354" src="https://github.com/user-attachments/assets/e2919bd8-73dd-4ff5-8e32-419ee0af43bc" />
